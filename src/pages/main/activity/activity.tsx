...
const activities = [
  ...
  return (
    <div className="p-4  bg-black text-white w-full h-full flex flex-col  ">
                ...
                {activities.map((activity, index) => (
                  <div key={index} className="grid grid-cols-12 gap-x-3">
                    ...
                    <div className=" col-span-8 p-1.5 pb-4">
                      <p className="flex gap-x-1.5 font-semibold  ">
...
{activity.details === "Ran Expenses" &&
          ...
          {activities.length > 5 &&(
        <div
          className="cursor-pointer border w-fit mx-auto mt-8 border-green-700 hover:bg-green-900 hover:text-black p-3 rounded transition-all"
        >
          Load More
        </div>
        )}
